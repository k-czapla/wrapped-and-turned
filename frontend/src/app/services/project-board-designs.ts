...
export const PROJECT_BOARD_DESIGNS: ProjectBoardDesign[] = [
  ...
  {
    id: slug('Tropical Craft'),
    name: 'Tropical Craft',
    vibe: 'Sun-soaked, punchy, vacation knitting',
    colors: 'Mango #FF8C42, turquoise #2DD4BF, palm #00C853, sunshine #FFD93D',
    layout: 'Big shapes, overlapping color blocks, palm-leaf patterns',
    style: {
      fontFamily: "'Fredoka', 'Nunito', sans-serif",
      background: 'linear-gradient(180deg, #FFD93D 0%, #FF8C42 40%, #2DD4BF 100%)',
      color: '#1A3C34',
      borderRadius: '20px',
      boxShadow: '8px 8px 0 #00C853, 16px 16px 0 rgba(0, 0, 0, 0.1)',
      fontWeight: '700',
    },
    promptHint: 'Tropical crochet mood board, bold fruit and leaf colors, beachy summer vibes',
  },
  {
    id: slug('Retro Pop Art'),
    name: 'Retro Pop Art',
    vibe: 'Comic-book bold, primary colors, halftone energy',
    colors: 'Pop red #E63946, royal blue #1D3557, banana yellow #FFE66D, stark white #F1FAEE',
    layout: 'Benday dots, thick outlines, speech-bubble shapes',
    style: {

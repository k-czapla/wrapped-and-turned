...
This folder contains the PRDs for **Wrapped and Turned**.

## Index

- `PRD-000-Overview.md` — product overview, goals, personas, success metrics
- `PRD-010-Wrapped.md` — “Wrapped” stats experience (date range → insights + charts)

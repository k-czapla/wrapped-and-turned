...
- **Multi-project carousel**: when more than one project is selected, prev/next and dot controls sit **between the photo gallery (or preview top) and the project board**, not below the board.
